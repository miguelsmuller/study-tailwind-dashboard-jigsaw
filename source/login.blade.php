    ...
    <div class="w-4/6 mx-auto py-8">
      ...
      <form action="/" class="px-4 py-5 sm:p-6 overflow-hidden rounded bg-gray-50 border border-gray-300">
        ...
        <div class="flex flex-col space-y-2 mt-6">
          <a href="/" class="w-full text-center px-6 py-2 rounded text-sm font-medium border-transparent bg-gray-900 text-white hover:bg-gray-600 focus:bg-gray-600 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600">Sign-in</a>
          
          <a href="/register/" class="w-full text-center px-6 py-2 rounded text-sm font-medium border-transparent bg-gray-200 text-gray-700 hover:bg-gray-200 focus:bg-gray-300 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300">Request your account</a>
